...
//
//@WebMvcTest(
//        controllers = MeetupController.class,
...
//        Meetup m = new Meetup("Test Club", "Cafe, Cluj", "2026-12-01T10:00",
...
//        when(meetupService.update(eq(1L), any())).thenReturn(Optional.of(sampleMeetup(1L)));
