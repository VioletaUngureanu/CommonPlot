...
import { validateLogin, hasAuthErrors } from '@/utils/authValidation'
import type { LoginErrors } from '@/utils/authValidation'
...
const getError = (field: keyof LoginErrors) =>
...
const handleLogin = async () => {
  ...
  const result = store.login(form.value.email, form.value.password)
  loading.value = false
  ...
  <div class="auth-page">
    <div class="auth-card">
      ...
      <div class="auth-logo" @click="router.push('/')">
        <img src="../assets/logo.png" alt="CommonPlot logo" class="auth-logo__img" />
      </div>
